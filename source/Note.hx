...
class Note extends FlxSprite
{
	...
	public var didthefunny:Bool = false;
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inEditor:Bool = false,?isburst:Bool = false)
	{
		super();
